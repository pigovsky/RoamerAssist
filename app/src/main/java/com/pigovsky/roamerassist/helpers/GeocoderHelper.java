...
public class GeocoderHelper {
    ...
    public static String fetchAddressFromLoactionUsingGoogleMap(Location location) {
    ...
    public static RoutePointsHelper.Point fetchLocationFromAddressUsingGoogleMap(String address) {
        ...
        try {
            ...
            RoutePointsHelper.Point location = new RoutePointsHelper.Point();
